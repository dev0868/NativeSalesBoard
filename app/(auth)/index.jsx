...
const OnBoardingPage = () => {
  ...
  return (
    <View className="flex-1 bg-gray-50">
      {/* Header with Navbar theme */}
      <LinearGradient
        colors={['#7c3aed', '#5b21b6']} // Same gradient as Navbar
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
      ...
      <View className="flex-1">
        ...
        >
          {carouselImages.map((item, index) => (
            <View key={item.id} style={{ width }} className="flex-1 px-5 justify-center">
              ...
              {/* Hero Card */}
              <View className="mt-8 rounded-2xl bg-white p-5 shadow-sm border border-gray-100 flex-1 max-h-96">
